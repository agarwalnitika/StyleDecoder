  ...
  return (
    ...
    <div className="flex gap-[5px]">
      <div className="inline-flex flex-col mr-[85px]">
        ...
        <textarea placeholder="Press Ctrl + 0 for new model. Press Ctrl + 1 for old model" className="border border-solid border-blue w-[500px] h-[250px] outline-none bg-blue-light text-grey p-[15px] text-xl font-medium rounded-[4px]" style={{resize:'none'}} name="text" onKeyDown={(e) => {
          handleKeyPress(e) 
        }}>
